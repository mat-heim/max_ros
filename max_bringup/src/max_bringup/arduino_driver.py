...
class Arduino:
    ...
    def eye_brow(self, left, right):
        return self.execute_ack('g %d %d' %(left, right))

    def eyes(self, pan, tilt):
        return self.execute_ack('l %d %d' %(pan, tilt))

    def ears(self, left, right):
        return self.execute_ack('h %d %d' %(left, right))

    def neck(self, left, right):
        return self.execute_ack('j %d %d' %(left, right))

    def mouth(self, a,b,c,d):
        return self.execute_ack('i %d.%d.%d.%d' %(a,b,c,d))

    def eyes_pan(self, pan, tilt):
        return self.execute_ack('e %d' %(pan))

    def eyes_tilt(self, tilt):
        return self.execute_ack('f %d' %(tilt))
