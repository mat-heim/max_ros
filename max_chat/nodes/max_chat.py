...
class Robbie_Chat():
    ...
    def __init__(self):
        rospy.init_node('max_chat_node', anonymous=True)
        self.robot ="Max"
        ...
        self.kern.setBotPredicate("birthday","1st of Febuary 2016")
        ...
        self.robot = rospy.get_param("~robot", self.robot)
